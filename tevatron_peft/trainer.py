...
class DenseTrainer(Trainer):
    ...
    def text_model(self,model,output_dir):
    ...
    def _save(self, output_dir: Optional[str] = None):
        ...
        # 分别保存passage和query
        self.text_model(self.model.lm_p,os.path.join(output_dir,'passage_model'))
        self.text_model(self.model.lm_q,os.path.join(output_dir,'query_model'))
